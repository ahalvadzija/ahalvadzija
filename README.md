...
> Backend-focused engineer with a systems-level mindset. I bridge the gap between clean code and rock-solid infrastructure. Currently building modern CLI tools and orchestrating high-scale enterprise systems.
...
[![Email](https://img.shields.io/badge/-Email-D14836?style=flat-square&logo=gmail&logoColor=white)](mailto:halvadzija.adnan@gmail.com)

---

### Philosophy

> "Code like it's 2026, test like your life depends on it." - I believe in automated everything, from unit tests to cloud deployments. 

<details>
<summary>Random Facts</summary>

- Favorite terminal font: JetBrains Mono
- Powered by strong coffee and clean log files
- Build time > Netflix time
- Gym enthusiast (resetting the brain after a long debug session)
